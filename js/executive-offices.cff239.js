...
function em1(){var c="benjoAfp.uy/dpn";var addr="mailto:";for(var i=0;i<c.length;i++)addr+=String.fromCharCode(c.charCodeAt(i)-1);window.location.href=addr;}
...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js1');e.setAttribute('src',(dpi>1)?'images/executive-offices-main-logo-1858.jpg':'images/executive-offices-main-logo-929.jpg');};
